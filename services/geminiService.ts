...
export const generateNewsReport = async (
  ...
  try {
      ...
      properties: {
        ...
        tweet: {
          ...
          properties: {
            ...
            url: { type: Type.STRING, description: "Link to tweet or user." },
    ...
    2. **TWEET**: Find the most significant or discussed tweet posted by @elonmusk in the last 48 hours. If multiple exist, pick the most relevant one. Return its text.
