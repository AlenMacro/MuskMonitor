...
export const ReportView: React.FC<ReportViewProps> = ({ report, isWriting = false }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {hasTweet && (
        <div className="bg-black border border-[#2f3336] rounded-2xl overflow-hidden animate-fade-in-up delay-100 max-w-2xl mx-auto md:mx-0 shadow-2xl">
             ...
             <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-1.5 text-[15px] leading-5 truncate">
                      <span className="font-bold text-[#e7e9ea] truncate text-base">Elon Musk</span>
                ...
                <div className="mt-4 flex justify-between max-w-[85%] text-[#71767b]">
                   ...
                   <a href={report.tweet!.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group cursor-pointer hover:text-[#1d9bf0] transition-colors">
                      <div className="p-2 -ml-2 rounded-full group-hover:bg-[#1d9bf0]/10 transition-colors">
